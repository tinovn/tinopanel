...
class InstallTest extends TestCase
{
    ...
    public function test_install_tino_agent(): void
    {
        SSH::fake('Active: active');
        Http::fake([
            'https://api.github.com/repos/tinodeploy/agent/tags' => Http::response([['name' => '0.1.0']]),
        ]);
    ...
    public function test_install_tino_agent_failed(): void
    {
        $this->expectExceptionMessage('Failed to fetch tags');
        SSH::fake('Active: inactive');
        Http::fake([
            'https://api.github.com/repos/tinodeploy/agent/tags' => Http::response([]),
        ]);
