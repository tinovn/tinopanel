...
namespace App\SSH\Services\Monitoring\TinoAgent;
...
class TinoAgent extends AbstractService
{
    use HasScripts;

    const TAGS_URL = 'https://api.github.com/repos/tinodeploy/agent/tags';

    const DOWNLOAD_URL = 'https://github.com/tinodeploy/agent/releases/download/%s';
